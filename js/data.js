      ...
      verticals: [
        {
          ...
          tagline: "One tile in the mosaic of finance. Not the whole job — one real task.",
          manual: {
            tool: "Excel",
            timeMin: 90,
            usableRate: 0.95,
          ...
          lenses: {
            career: {
              shift:
                "Entry-level analysts used to earn their stripes building statements line by line. AI now drafts the first pass in minutes — the job is shifting from 'can you build it' to 'can you catch what's wrong with it.' And the stakes are real: sending client filings or MNPI to a public AI tool risks the kind of compliance breach that got major banks to restrict ChatGPT outright.",
              skillsRising: [
            ...
            environment: {
              ...
              factors: "Per income statement (workstation screen-time vs. device + ~15 AI prompts).",
            },
          },
          realityCheck: {
            pitch: "“AI drafts your financial models 10x faster.”",
            evidence:
              "Real benchmarks on multi-line financial statements (FinanceBench, FinMaster) put accuracy around 37–40%. AI needs to be right 33% of the time just to break even on cost — the assumed 40% barely clears that bar, and a bad figure can invalidate the whole statement.",
          },
          sources: [
            ...
            { name: "Federal Reserve Bank of St. Louis / NBER — generative-AI adoption & productivity by occupation", date: "2025", url: "https://www.stlouisfed.org/on-the-economy/2025/feb/impact-generative-ai-work-productivity" },
          ],
        },
      ],
    },
      ...
      verticals: [
        {
          ...
          tagline: "One tile in the mosaic of design. Not the whole job — one real task.",
          manual: {
            tool: "Photoshop",
            timeMin: 45,
            usableRate: 0.95,
          ...
          lenses: {
            career: {
              shift:
                "AI wins on cost so overwhelmingly here — it would still be cheaper even at an 17% keeper rate — that this isn't really an economic decision anymore. The real question for designers is whose work trained the model, and who gets paid for it going forward.",
              skillsRising: [
            ...
            environment: {
              ...
              factors: "Per image (workstation screen-time vs. device + ~1.5Wh diffusion-model inference).",
            },
          },
          realityCheck: {
            pitch: "“Generate unlimited royalty-free images instantly.”",
            evidence:
              "Firefly is trained on licensed Adobe Stock content with IP indemnity — the lowest-legal-risk mainstream option. But reporting found ~5% of that training data was itself AI-generated, and the deeper fight over creator displacement and uncompensated labor is unresolved. Cheap and low-risk aren't the same as uncontested.",
          },
          sources: [
      ...
      verticals: [
        {
          ...
          tagline: "One tile in the mosaic of engineering. Not the whole job — one real task.",
          manual: {
            tool: "Hand-code",
            timeMin: 60,
            usableRate: 0.90,
          ...
          lenses: {
            ...
            environment: {
              ...
              factors: "Per task (workstation screen-time vs. device + LLM completions/prompts).",
            },
          },
          realityCheck: {
            pitch: "“Ship features up to 55% faster with AI pair programming.”",
            evidence:
              "True for routine, bounded tasks. But METR's randomized controlled trial found experienced developers took *longer* on complex, real-world repos with AI assistance — while feeling faster. And Veracode found ~45% of AI-generated code samples introduce an OWASP Top-10 vulnerability, a rate that's held flat for two years running.",
          },
          sources: [
            { name: "METR — randomized controlled trial on AI coding assistance & developer speed", date: "2025", url: "https://www.infoworld.com/article/4020931/ai-coding-tools-can-slow-down-seasoned-developers-by-19.html" },
